 ...
 ;(function() {
  ...
  Canteen.prototype = { 
    ...
    hash: function(config) {
      return Canteen.sha1(this.json(config));
    },
    /**
     * clear the stack
     * @method clear
...
;/*
 * JavaScript sha1 1.0.1
 * https://github.com/blueimp/JavaScript-sha1
 *
 ...
 * 
 * Based on
 * A JavaScript implementation of the RSA Data Security, Inc. sha1 Message
 * Digest Algorithm, as defined in RFC 1321.
 * Version 2.2 Copyright (C) Paul Johnston 1999 - 2009
 * Other contributors: Greg Holt, Andrew Kepert, Ydnar, Lostinet
 * Distributed under the BSD License
 * See http://pajhome.org.uk/crypt/sha1 for more info.
 */
