            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src=<?= base_url("template/img/service/servicess1.png");?> alt="">
                            </div>
                            <div class="service-cap">
                                <h4><a href="services_details.html">Calibracion</a></h4>
                                <a href="services_details.html" class="more-btn">Leer Mas  <i class="ti-plus"></i></a>
                            </div>
                            <div class="service-icon">
                                <img src=<?= base_url("template/img/icon/services_icon1.png");?> alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src=<?= base_url("template/img/service/servicess2.png");?> alt="">
                            </div>
                            <div class="service-cap">
                                <h4><a href="services_details.html">Medicion</a></h4>
                                <a href="services_details.html" class="more-btn">Leer Mas  <i class="ti-plus"></i></a>
                            </div>
                            <div class="service-icon">
                                <img src=<?= base_url("template/img/icon/services_icon1.png");?> alt="">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src=<?= base_url("template/img/service/servicess3.png");?> alt="">
                            </div>
                            <div class="service-cap">
                                <h4><a href="services_details.html">Basculas</a></h4>
                                <a href="services_details.html" class="more-btn">Leer Mas <i class="ti-plus"></i></a>
                            </div>
                            <div class="service-icon">
                                <img src=<?= base_url("template/img/icon/services_icon1.png");?> alt="">
